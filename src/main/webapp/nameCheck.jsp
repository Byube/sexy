...
<form action="/sexy/checkCnameFun.vip" name="cnameFrm" method="post">
<table width="400" height="289"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" background="/sexy/img/join_pop_bg.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="45" colspan="3"><img src="/sexy/myUpload/cnameCheck.png" width="400" height="45" /></td>
      </tr>
      <tr>
...
<c:otherwise>
      <tr>
        ...
        <tr>
          <td>&nbsp;</td>
          <td height="40" align="center" bgcolor="F5F5F5"><strong>업체명</strong> 입력
            <input type="text" name="ccname" id="ccname" class="input" />
            <input id="idImg" type="image" src="/sexy/img/btn_confirm_re.gif" width="59" height="18" border="0" align="absmiddle"  /></td>
          <td>&nbsp;</td>
        </tr>
      <tr>
        <td>&nbsp;</td>
