...
<script  src="/sexy/js/joinMember.js" charset="UTF-8"></script>

</head>

<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">

<form action="/sexy/checkIdFun.vip" name="idFrm" method="post">
<table width="400" height="289"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" background="/sexy/img/join_pop_bg.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="45" colspan="3"><img src="/sexy/img/join_pop_title2.gif" width="130" height="20" /></td>
      </tr>
      <tr>
